...
function interactivePortfolio() {
  ...
  var projects = {
    ...
    layoutletter:{category:"AUTOMATION • CREATOR TOOL",title:"LayoutLetter",summary:"A visual newsletter builder for creators and businesses that makes campaign assembly faster and more approachable.",contribution:["Product interface concept","Visual builder workflow","Responsive front-end experience","Automation-oriented interaction design"],stack:["Automation","Zapier","Newsletter","Builder","UI/UX"],links:[{label:"Open Project",url:"preview/LayoutLetter.com/index.html",external:true}]},
    marketingos:{category:"AUTOMATION • MARKETING OPERATIONS • DEMO",title:"Marketing Centralized AI-Powered System",summary:"A unified workspace for campaigns, content, tasks, publishing, and marketing intelligence. This public version is a demo only—not the actual client output, which remains confidential.",contribution:["Campaign workspace demonstration","Content and task workflow presentation","Publishing operations interface","Marketing intelligence dashboard"],stack:["Python 3","n8n","Automation","Campaign Ops","Marketing Intelligence"],links:[{label:"Open Demo",url:"https://python-ph-marketing-os.vercel.app/",external:true}]},
    prospectos:{category:"AUTOMATION • SOCIAL-FIRST LEAD GENERATION",title:"Prospect OS",summary:"A social-first prospecting engine that discovers high-intent businesses, prioritizes opportunities, and turns social signals into qualified conversations.",contribution:["High-intent business discovery","Lead scoring and prospect prioritization","Personalized outreach workspace","Follow-up and performance analytics"],stack:["Lead Generation","Automation","Prospect Research","Outreach","Analytics"],links:[{label:"Open Prospect OS",url:"https://leadfinder-gules.vercel.app/",external:true}]},
    mountain:{category:"WEB • TOURISM",title:"Discover Mountain Province",summary:"A destination website for exploring Mountain Province through places, stories, and trip ideas.",contribution:["Tourism content structure","Destination-focused visual system","Responsive implementation","Discovery pathways"],stack:["HTML5","CSS3","JavaScript ES6+","Tourism UX"],links:[{label:"Open Project",url:"preview/DiscoverMountainProvince/index.html",external:true}]},
    readystation:{category:"WEB • LMS",title:"ReadyStation LMS",summary:"A training platform built for first responders and the realities of fireground preparation.",contribution:["LMS product presentation","First-responder workflow framing","Responsive interface","Training-focused user experience"],stack:["LMS","Training","First Responders"],links:[{label:"Open Project",url:"preview/ReadyStation/index.html",external:true}]},
