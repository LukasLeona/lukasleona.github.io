            ...
            <Modal.Body className='Inter-normal text-white'>
                <div className='register-form p-5 mx-auto text-black shadow-lg text-center'>
                    ...
                    <Form.Group controlId="formEmail">
                        <Row>
                        <p className='Inter-regular text-14px mb-3'>Enter the <span className='Inter-b'>PUP webmail</span> associated with your account:</p>
                        </Row>
                        <Row className='mx-5 px-5'>
                        <Form.Control className="Inter-normal text-16px" type="email" placeholder="sample@iskolarngbayan.pup.edu.ph" onChange={(e) => setForgotPasswordDetails({...forgotPasswordDetails, email: e.target.value})}/>
                        </Row>
                    </Form.Group>
                    </Row>
                    ...
                    <Row className="mt-3">
                                <Col/>
                                <Button as={Col} xs={6} variant="primary" type="submit" onClick={handleSubmit}>
                                    Submit
                                </Button>
                                <Col/>
                            </Row>
 ...
 */}
 ...
 {loading && <LoadingOverlay title={"Sending Email..."}/>}
