...
CREATE TABLE `Org_Announcements` (
  ...
  `org_ann_photo` varchar(255) DEFAULT NULL,
  `org_ann_title` varchar(255) NOT NULL,
  `org_ann_link` varchar(255) NOT NULL,
  `org_ann_body` varchar(255) NOT NULL,
  `orgId` int NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `orgId` (`orgId`),
  CONSTRAINT `Org_Announcements_ibfk_1` FOREIGN KEY (`orgId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
