...
$('.calendar-button')?.addEventListener('click', () => {
  ...
  const ics = [
    'BEGIN:VCALENDAR','VERSION:2.0','PRODID:-//Kevin and Sharmaine//Wedding//EN','BEGIN:VEVENT',
  ...
  const anchor = Object.assign(document.createElement('a'), { href: url, download: 'kevin-sharmaine-wedding.ics' });
  anchor.click();
...
const STORAGE_KEY = 'kevin-sharmaine-guest-gifts-v2';
const starterGifts = [
